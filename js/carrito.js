...
const airpodspro = new Producto(2, "Airpods PRO", 159.99, "../img/airpodspro.jpg");
const cableusb = new Producto(3, "Cable USB", 19.99, "../img/cable1usb.jpg");
const iphone12 = new Producto(4, "iPhone 12", 899, "../img/iphone-12-128gb-original-apple.jpg");
const iphone11 = new Producto(5, "iPhone 11", 749, "../img/iphone12azul.jpg");
const iphone11pro = new Producto(6, "iPhone 11 PRO", 849, "../img/iphone11pro.jpg");
const iphone12mini = new Producto(7,"iPhone 12 MINI", 849, "../img/iphone-12mininegro.jpg");
const yerba = new Producto(8, "Yerba", 120, "img/yerba.png");

//Creamos un Array con todo nuestro catálogo de productos: 

const productos = [airpods, airpodspro, cableusb, iphone12, iphone11, iphone11pro, iphone12mini, yerba];
